	...
	public class UserLoginTask extends AsyncTask<String, Void, Boolean> {
		...
		protected Boolean doInBackground(String... params) {
			...
			try {
				...
				//getting user details by making HTTP GET request
				JSONObject json = jsonParser.makeHttpRequest(url_user_details, "GET", paramss);
				...
				if(success == 1){
					...
					JSONArray userobject = json.getJSONArray(USER_TAG); // JSON Array of users
